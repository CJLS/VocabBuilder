...
public class ExportTest {
    ...
    @Test
    public void clickExportMenuButton_showExportCategoryDialog() throws Exception {
        openActionBarOverflowOrOptionsMenu(InstrumentationRegistry.getTargetContext());
        onView(withText(InstrumentationRegistry.getTargetContext().getString(R.string.export)))
                .perform(click());
